var ARSN_IPFS = artifacts.require("./ARSN_IPFS.sol");
...
contract("ARSN_IPFS", function(accounts) {
  	var ipfs;
...
it("it inserts observation from Training_Data_1", function() {
  return ARSN_IPFS.deployed().then(function(instance) {
    var fs = require("fs");
...
it("testing retrieval function ", function() {
  ...
  return ipfs.retrieveRecord.call("GBM", "306", "BCNU");
        ...
        console.log("ipfs hash for [Scoliosis  306  2]");
